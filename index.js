...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction can access the variable 'internal' because it can access variables in myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  console.log('topic2', animalNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulation = array.filter(element => element.population < 5);
  ...
  */
  ...
  function USApop(array){
    const popTotal = array.reduce(function(accumulator, element){
